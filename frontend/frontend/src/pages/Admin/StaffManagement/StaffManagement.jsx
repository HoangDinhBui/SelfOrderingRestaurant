...
const StaffManagementAdmin = () => {
  ...
  const [selectedStaffTimekeeping, setSelectedStaffTimekeeping] = useState(null);
  ...
  const mockTimekeepingData = [
    { id: 1, fullName: "John Doe", checkIn: "08:00 AM", checkOut: "05:00 PM", salary: 50000 },
    { id: 2, fullName: "Jane Smith", checkIn: "09:00 AM", checkOut: "06:00 PM", salary: 45000 },
    { id: 3, fullName: "Alice Johnson", checkIn: "07:30 AM", checkOut: "04:30 PM", salary: 48000 },
    { id: 4, fullName: "Bob Brown", checkIn: "08:30 AM", checkOut: "05:30 PM", salary: 52000 },
  ];
                ...
                <table style={styles.timekeepingTable}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={styles.timekeepingTd}>{selectedStaffTimekeeping.id}</td>
                    </tr>
                    <tr>
                      <td style={styles.timekeepingTd}>Name</td>
                      <td style={styles.timekeepingTd}>{selectedStaffTimekeeping.fullName}</td>
                    </tr>
                    <tr>
                      <td style={styles.timekeepingTd}>Check-in Time</td>
                      <td style={styles.timekeepingTd}>{selectedStaffTimekeeping.checkIn}</td>
                    </tr>
                    <tr>
                      <td style={styles.timekeepingTd}>Check-out Time</td>
                      <td style={styles.timekeepingTd}>{selectedStaffTimekeeping.checkOut}</td>
                    </tr>
                    <tr>
                      <td style={styles.timekeepingTd}>Salary</td>
                      <td style={styles.timekeepingTd}>{selectedStaffTimekeeping.salary}</td>
                    </tr>
                  </tbody>
                </table>
                <div style={styles.actionButtons}>
